<template>
  <v-row justify="center" cols="auto">
    <v-col cols="7">
      <span class="subtitle-1" style="font-size: 1rem; font-weight: bold; text-align: center;">상품문의</span>
    </v-col>
    <v-col cols="7">
      <v-card cols="auto">
              ...
              <v-col cols="12">
                <v-row>
                  ...
                  <v-col cols="12" class="d-flex justify-content-between">
                    <div>
                      <span>{{ inquiry.qna_title }}</span>
                      <v-icon v-if="user_id !== inquiry.user_id">mdi-lock</v-icon>
                    </div>
