<template>
  <div class="container">
    <div class="order-details-wrapper">
      ...
      <span>취소요청 날짜: {{ formatDate(data.user.cancel_req_date) }} </span><br />
      <span v-if="data.user.cancel_complete_date">취소완료 날짜 : {{ formatDate(data.user.cancel_complete_date) }}</span>
    ...
    <div class="back-button-wrapper">
      <button class="back-button">
        <RouterLink to="/admin/cancelList">돌아가기</RouterLink>
      </button>
    </div>
  </div>
</template>
