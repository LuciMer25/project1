<template>
  <div class="container">
    <div class="order-details-wrapper">
      ...
      <span>반품요청 날짜: {{ formatDate(data.user.return_req_date) }} </span><br />
      <span v-if="data.user.return_complete_date">반품완료 날짜 : {{ formatDate(data.user.return_complete_date) }}</span>
    ...
    <div class="back-button-wrapper">
      <button class="back-button">
        <RouterLink to="/admin/returnList">돌아가기</RouterLink>
      </button>
    </div>
  </div>
</template>
