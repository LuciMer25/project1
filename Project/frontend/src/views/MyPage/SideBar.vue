    ...
    <div class="inner">
        <h3 class="title-t ty3">마이페이지</h3>
                <dl class="mypage-menu-list">
                    ...
                    <dd><a href="https://www.ottogimall.co.kr/front/mypage/benefit_smoney" class="">마일리지</a></dd>
                    ...
                    <dd><a href="https://www.ottogimall.co.kr/front/mypage/cs_letter" class="">뚜밀리숲 확인</a></dd>
