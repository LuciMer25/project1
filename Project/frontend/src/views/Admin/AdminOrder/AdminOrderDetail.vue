	...
	<div class="orderBox">
        <div class="order">
            ...
            <div class="order-details">
                ...
                <a href="productInfo.do?prodNo=${order.PROD_NO}"><img class="prodImage" src="e:/upload/천혜향.webp" alt="상품 이미지"></a>
                <div class="product-info">
                    <div class="info">
                        <a href="#" target="_blank">상품명</a>
                        <span>
                             원 ·  개
                        </span>
                    </div>
